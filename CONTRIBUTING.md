...
This outlines how to propose a change to cookies.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("shinyworks/cookies", fork = TRUE)`.
...
- Prefix unexported functions with `.`, such as `.unexported_function`.
...
Code of Conduct](https://cookies.shinyworks.org/CODE_OF_CONDUCT.md). By
